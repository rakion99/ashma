...
static LuauInstruction generateABx(uint8_t op, uint8_t a, uint16_t bx)
{
...
static LuauInstruction generateAB(uint8_t op, uint8_t a, uint8_t b)
{
    LuauInstruction inst(0);
    inst.op = op;
    inst.a = a;
...
static LuauInstruction generateA(uint8_t op, uint8_t a)
{
    LuauInstruction inst(0);
    inst.op = op;
    inst.a = a;
...
static LuauInstruction generateSbx(uint8_t op, uint8_t a, int16_t sbx)
{
    LuauInstruction inst(0);
    inst.op = op;
    inst.a = a;
...
static LuauInstruction generateABC(uint8_t op, uint8_t a, uint8_t b, uint8_t c)
{
    LuauInstruction inst(0);
    inst.op = op;
    inst.a = a;
...
static std::vector<LuauInstruction> push_instrs(Proto* p)
{
